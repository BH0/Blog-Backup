...
/// “new” and Constructor Functions (similar to classes - first letter should be capitalised) 
var car = new Object;
function Person(age) { 
   this.personAge = age; 
} 
var oldPerson = new Person(200); // new AnArray().localArray[1]; 
console.log("age: " + oldPerson.personAge); 
``` 
